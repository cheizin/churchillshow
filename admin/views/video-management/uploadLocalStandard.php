...
<div class="row">
  <div class="col-lg-12 col-xs-12">
    <div class="card card-primary card-outline">
      <div class="card-header">
        My Local Videos NB: Videos appear public upon verification by Churchill
  ...
  <img class="card-img" src="https://churchill.potentialsoftwares.com/images/favoriteCompressed/<?php echo $row['thumbnail'];?>" alt="Video Thumbnail">
  <div class="card-img-overlay">
      <div class="card-content" style="background: rgba(0,0,0, 0.7);">
       ...
       <!--   <h5 class="m-3"><i class="far fa-play-circle"></i> <a class="btn btn-link" href="https://churchill.potentialsoftwares.com/videos/<?php echo $row['videoname'];?>"> Play</a></h5> -->
