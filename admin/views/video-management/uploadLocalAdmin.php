         ...
         <tr style="cursor: pointer;">
           ...
           <td>
             <?php
                ...
                <td>    <a href="https://churchill.potentialsoftwares.com/images/favorite/<?php echo $row['thumbnail'];?>" target="_blank">
               ...
               <?php echo $row['thumbnail'];?>
                ...
                <td>    <a href="https://churchill.potentialsoftwares.com/videos/<?php echo $row['videoname'];?>" target="_blank">
